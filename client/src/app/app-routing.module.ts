...
const routes: Routes = [
...

  {
    ...
    component: DisplaySurveyListComponent,
    data: { title: "Survey List" },
    canActivate: [AuthGuard]
  },
  {
    path: "survey/display-survey/add",
    component: CreateSurveyComponent,
    data: { title: "Create A Survey!" },
    canActivate: [AuthGuard]
  },
  {
    path: "survey/display-survey/delete/:id",
    component: CreateSurveyDeleteComponent,
    data: { title: "Deleted Survey!" },
    canActivate: [AuthGuard]
  },
  {
    path: "survey/display-survey/deactivate/:id",
    component: CreateSurveyDeactivateComponent,
    data: { title: "Survey Deactivated!" },
    canActivate: [AuthGuard]
  },

  {
    path: "survey/answer-survey/submit/:id",
    component: AnswerSurveyComponent,
    data: { title: "Submit Answer" }
  },
